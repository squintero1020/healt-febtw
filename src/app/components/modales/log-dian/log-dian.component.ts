...
@Component({
  selector: 'app-log-dian',
  templateUrl: './log-dian.component.html',
  styleUrls: ['./log-dian.component.scss']
})
export class LogDianComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.facturasTimbradrasForm = new FormGroup({
      ...
      ObservacionDian : new FormControl({value:'',disabled:true}),
